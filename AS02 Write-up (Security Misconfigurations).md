...
จากข้อมูลที่หน้าเว็บให้มา จึงลองเรียก API เพื่อดึงข้อมูลผู้ใช้ตามหมายเลข ID  
โดยใช้คำสั่ง `curl` ดังนี้
...
ผลลัพธ์คือระบบตอบกลับข้อมูลผู้ใช้ทุกครั้ง แม้จะไม่ได้ทำการ login หรือยืนยันตัวตนใด ๆ
